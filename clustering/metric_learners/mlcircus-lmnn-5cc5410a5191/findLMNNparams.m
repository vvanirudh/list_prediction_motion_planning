...
% function [K,maxiter,mu]=findLMNNparams(xTr,yTr)
...
opt.max_iters = 12; % Override the default max_iters value -- probably don't need 100 for this simple demo function.
opt.grid_size = 20000;
